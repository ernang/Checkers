 ...
 * @version 1.0
 */
public class PlayerMiniMax1 implements IPlayer, IAuto {
     ...
     */
    public PlayerMiniMax1(int profunditat) {
    ...
    private double evaluarEstatAux(GameStatus s, PlayerType jugador) {
        ...
        heuristica += 2*queenPieces + pawnPieces;
        return heuristica;
    }
